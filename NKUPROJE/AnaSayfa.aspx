<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="NKUPROJE.AnaSayfa" %>
                ...
                <table class="auto-style4">
                    ...
                    <tr>
                        <td class="auto-style5" style="background-color: #C0C0C0">
                            ...
                            <asp:Label ID="Label2" runat="server" style="font-weight: 700; font-size: x-large; color: #FFFFFF;" Text='<%# Eval("YemekAd") %>'></asp:Label></a>
